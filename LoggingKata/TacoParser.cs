    ...
    public class TacoParser
    {
        ...
        public ITrackable Parse(string line)
        {
            ...
            if (cells.Length < 3)
            {
                ...
                logger.LogWarning("Your array is less than 3");
                return null; 
            }
            ...
            var tacoBellPoint = new Point();
            tacoBellPoint.Latitude = latitude;
            tacoBellPoint.Longitude = longitude;

            // TODO: Create an instance of the TacoBell class
            // TODO: Set the values of the class correctly (Name and Location)
            var tacoBell = new TacoBell();
            tacoBell.Name = name;
            tacoBell.Location = tacoBellPoint;
